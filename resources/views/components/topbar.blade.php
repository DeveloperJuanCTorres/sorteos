...
<nav class="fixed top-0 w-full z-50 h-16 bg-[#091328] shadow-[0_8px_32px_rgba(6,14,32,0.6)]">
    <div class="flex justify-between items-center px-6 w-full max-w-screen-xl mx-auto h-full">
        <div class="flex items-center gap-3">
            <a href="/login" class="w-10 h-10 rounded-full bg-surface-variant flex items-center justify-center text-[#90abff] hover:bg-[#192540] hover:scale-105 transition-all active:scale-95 duration-200 cursor-pointer">
